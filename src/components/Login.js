// this is the side bar which opens on hover and allows the user to sign in/ sign up
...
export default function Login({ onVisibilityChange }) {
    ...
    return (
            ...
            className={`fixed top-0 right-0 transition-all duration-300 shadow-md h-full ${

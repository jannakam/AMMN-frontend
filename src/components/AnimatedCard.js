...
const AnimatedCard = () => {
  ...
  return (
    <svg version="1.1" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" viewBox="0 0 600 368">
      <defs>
        <mask id="chipMask">
      ...
      <g mask="url(#cardMask)">
        ...
        <g clipPath="url(#orbClip1)">
          <image className="scratches" width="150" xlinkHref="https://assets.codepen.io/721952/scratches2.png" />
        ...
        <g fill="#fff" strokeLinecap="round">
          ...
          <path fill="none" stroke="#fff" strokeWidth="2.4" d="M42.5,146.5c2,2,2,6.3,0,8.2 M57,163.7c5.1-5.9,5.1-19.8,0-26.3 M52.1,160.7c4.4-4.5,4.9-15.2,0-20.2 M47.8,157.2c2.9-3,2.9-10,0-13.2" />

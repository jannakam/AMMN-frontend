  ...
  const itemTemplate = (item) => (
    <div className="h-screen flex flex-col justify-center items-center">
      <div className="text-center p-6 rounded w-3/4">
        <div className="text-primary font-bold mb-4 text-5xl noto-kufi-arabic">
          {item.title}
        </div>
        ...
        <Button
          label={item.button}
          className="p-button-lg p-button-primary p-2 w-3 bg-primary"
        />
      </div>
    </div>
  );
  ...
  return (
    <div className="relative h-screen overflow-hidden">
      ...
      <div className="absolute top-0 left-1/2 -translate-x-1/2 z-10">
        <Image src="/assets/ammn_logo_black.svg" alt="Your Logo" width={300} height={50} />
      </div>
